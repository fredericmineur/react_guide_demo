  ...
  render() {
    return (
      <div className="App">
        ...
        {/*Here it does the same as clicking on the button, but on clicking on the person paragraph*/}
        {/*We pass the props.click from the Person component <p onClick={props.click}>*/}
        <Person click={this.switchHandler} name={this.state.persons[0].name} age={this.state.persons[0].age}>
